...
MAIN_SH_ARGS = <<MARKER
-e "playbook_name=ansible-elastic discord_message_owner_name=#{Etc.getpwuid(Process.uid).name}"
MARKER
NODE_COUNT = 1
  ...
  (1..NODE_COUNT).each do |i|
    config.vm.define "node#{i}" do |subconfig|
      ...
      subconfig.vm.provider :aws do |aws, override|
        ...
        aws.security_groups = ["sg-020afd8fd0fa9fd0b","sg-045f3cbbf63f79d2c", "sg-00cd6b533fef19ceb"]
        # public-ssh, elastic, consul
